...
completedTourney = MKS.tournaments.create(game_type: "Smash Bros", name: "MKS CompletedTourney", champion_id: 3, size: 4)
...
#4 person test tourney
inProgressTourney = MKS.tournaments.create(game_type: "Smash Bros", name: "MKS TourneyInProgress", size: 4)
